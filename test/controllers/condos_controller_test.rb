...
class CondosControllerTest < ActionController::TestCase
  ...
  test "should create condo" do
    assert_difference('Condo.count') do
      post :create, condo: { address: @condo.address, contact_email: @condo.contact_email, name: @condo.name }
    end
  ...
  test "should update condo" do
    patch :update, id: @condo, condo: { address: @condo.address, contact_email: @condo.contact_email, name: @condo.name }
    assert_redirected_to condo_path(assigns(:condo))
  end
